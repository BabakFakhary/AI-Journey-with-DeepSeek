...
# مثال ساده برای درک 
  # فرض کنید این جمله را داریم: گربه موش را دنبال کرد
  # مراحل پردازش:
    # توکنایز کردن: ["گربه", "موش", "را", "دنبال", "کرد"]
    # Embedding: تبدیل کلمات به اعداد
    # Positional Encoding(PE): اضافه کردن اطلاعات موقعیت کلمات
    # Attention: مدل یاد می‌گیرد که:
      # "گربه" به "دنبال" مرتبط است
      # "موش" به "دنبال" مرتبط است
      # "دنبال" به "کرد" مرتبط است
# --------------------------------------------------------------------------------------------------------
